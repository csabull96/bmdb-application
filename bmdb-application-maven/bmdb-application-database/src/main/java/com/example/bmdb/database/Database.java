...
public class Database {
	...
	public Database() {
		...
		Actor theRock = new Actor("Dwayne Johnson", LocalDate.of(1972, 5, 2), Sex.MALE, "Also known by his ring name The Rock, is an American actor, producer, businessman, and former professional wrestler[7] and football player");
		Actor nickJonas = new Actor("Nick Jerry Jonas", LocalDate.of(1992, 9, 16), Sex.MALE, "American singer, songwriter and actor.");
		Actor robCorddry = new Actor("Robert William Corddry", LocalDate.of(1971, 2, 4), Sex.MALE, "American actor and comedian.");
		Actor matthewMcConaughey = new Actor("Matthew McConaughey", LocalDate.of(1969, 11, 4), Sex.MALE, "American actor and producer.");
		Actor anneHathaway = new Actor("Anne Hathaway", LocalDate.of(1982, 11, 12), Sex.FEMALE, "American actress. The recipient of multiple awards, including an Academy Award, a Primetime Emmy Award, and a Golden Globe, she was one of the highest-paid actresses in the world in 2015.");
		Actor charlieHunnam = new Actor("Charles Matthew Hunnam", LocalDate.of(1980, 4, 10), Sex.MALE, "English actor.");
		Actor jenniferAniston = new Actor("Jennifer Joanna Aniston", LocalDate.of(1969, 2, 11), Sex.FEMALE, "American actress, film producer, and businesswoman. Aniston rose to international fame portraying Rachel Green on the television sitcom Friends, for which she earned Primetime Emmy, Golden Globe, and Screen Actors Guild awards.");
		Actor mattLeBlanc = new Actor("Matthew Steven LeBlanc", LocalDate.of(1967, 7, 25), Sex.MALE, "American actor and comedian. He is best known for his portrayal of dim-witted yet well-intentioned womaniser Joey Tribbiani in the NBC sitcom Friends and in its spin-off series Joey.");
		Actor matthewPerry = new Actor("Matthew Langford Perry", LocalDate.of(1969, 8, 19), Sex.MALE, "American-Canadian actor, comedian and playwright who gained worldwide recognition for his role as Chandler Bing on the NBC television sitcom Friends.");
		...
		Media jumanji = new MediaBuilder().setId(new BigDecimal(0))
				                          ...
				                          .setPremiereDate(LocalDate.of(2017, 12, 21))
		...
		Media ballers = new MediaBuilder().setId(new BigDecimal(1))
										  ...
										  .setPremiereDate(LocalDate.of(2015, 6, 22))
										  .addCastMember(theRock)
		...
		Media interstellar = new MediaBuilder().setId(new BigDecimal(2))
											   ...
											   .setPremiereDate(LocalDate.of(2014, 11, 6))
		...
		Media gentlemen = new MediaBuilder().setId(new BigDecimal(3))
											...
											.setPremiereDate(LocalDate.of(2020, 1, 30))
											.addCastMember(matthewMcConaughey)
		...
		Media friends = new MediaBuilder().setId(new BigDecimal(4))
										  ...
										  .setPremiereDate(LocalDate.of(1994, 9, 29))
